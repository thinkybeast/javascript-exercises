// Implement the following diagram using the pseudo-classical approach (https://dbdwvr6p7sskw.cloudfront.net/js-exercises/object_creation_patterns/Classical.png). Subclasses should inherit everything from the superclass and not just the methods. Reuse the constructors of the superclass when implementing a subclass.
